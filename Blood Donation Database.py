...
bg = input("Enter the type of blood group you want details about:")
print("These places in Bangalore have donors who can donate the", bg, "blood group: ")
for element in lst:
    if bg in element:
        print(element[2])

print("From which branch do you want blood, out of the above?")
place = input()
for element in lst:
    if place in element:
        print("You can contact", element[0], "to get blood from this place.")

print("For more information, click here: http://www.listofdonors.com/donors-in-bangalore") #We can access other cities by changing the city name at the end of url
